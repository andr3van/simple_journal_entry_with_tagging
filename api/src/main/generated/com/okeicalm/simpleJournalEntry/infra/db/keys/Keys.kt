...
val KEY_JOURNAL_ENTRY_TAGS_PRIMARY: UniqueKey<JournalEntryTagsRecord> = Internal.createUniqueKey(JournalEntryTags.JOURNAL_ENTRY_TAGS, DSL.name("KEY_journal_entry_tags_PRIMARY"), arrayOf(JournalEntryTags.JOURNAL_ENTRY_TAGS.ID), true)
...
val JOURNAL_ENTRY_TAGS_IBFK_1: ForeignKey<JournalEntryTagsRecord, JournalEntriesRecord> = Internal.createForeignKey(JournalEntryTags.JOURNAL_ENTRY_TAGS, DSL.name("journal_entry_tags_ibfk_1"), arrayOf(JournalEntryTags.JOURNAL_ENTRY_TAGS.JOURNAL_ENTRY_ID), com.okeicalm.simpleJournalEntry.infra.db.keys.KEY_JOURNAL_ENTRIES_PRIMARY, arrayOf(JournalEntries.JOURNAL_ENTRIES.ID), true)
